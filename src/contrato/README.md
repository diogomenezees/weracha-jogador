...
| `tipos.ts` | `weracha-site/docs/especificacao/16-api-v1.md` + `weracha-site/app/api/v1/**` + `weracha-site/lib/auth-tipos.ts` | Request/response das rotas que o app consome (inclui `StatusTelefone`/`EnvioCodigoSms` do fluxo de acesso) |
